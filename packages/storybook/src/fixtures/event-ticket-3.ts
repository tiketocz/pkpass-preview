// Ported from pkpass-builder-ui src/stories/fixtures/event-ticket3.ts (numeric placeholders only).

import { PLACEHOLDER_ICON_PNG } from "./_placeholder";

export const eventTicket3 = {
  "pass.json": {
    ...
    eventTicket: {
      ...
      secondaryFields: [
        ...
        { key: "secondary-vbxrs", label: "4444", value: "4444" },
        { key: "secondary-rglns", label: "5555", value: "5555" },
      ],
    },
    ...
    serialNumber: "sample-eventticket-3",
  },

// Anonymized from pkpass-builder-ui src/stories/fixtures/generic6.ts (twin of generic5).
// Same shape; brand → "Sandcastle Athletic Society".

import { PLACEHOLDER_ICON_PNG } from "./_placeholder";

export const generic6 = {
  "pass.json": {
    ...
    serialNumber: "sample-sandcastle-member-6",
  },

// Anonymized from pkpass-builder-ui src/stories/fixtures/store-card2.ts (insurance assistance card, 4-col).
// Org was already neutral; back-fields translated CZ → EN.

import { PLACEHOLDER_ICON_PNG } from "./_placeholder";

export const storeCard2 = {
  "pass.json": {
    ...
    serialNumber: "sample-storecard-2",
    storeCard: {
      backFields: [
        {
          key: "back-info",
      ...
      secondaryFields: [
        ...
        {
          key: "secondary-valid-from",
          label: "VALID FROM",
          textAlignment: "PKTextAlignmentLeft",
          value: "01.01.2023",
        },
        {
          key: "secondary-valid-to",
          label: "VALID TO",
          textAlignment: "PKTextAlignmentLeft",
          value: "01.03.2024",
        },

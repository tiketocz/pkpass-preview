// Anonymized from pkpass-builder-ui src/stories/fixtures/back-fields.ts (back-fields demo card).
// Org already neutral; back-fields translated CZ → EN, generic content.

import { PLACEHOLDER_ICON_PNG } from "./_placeholder";

export const backFields1 = {
  "pass.json": {
    ...
    serialNumber: "sample-backfields-1",
    storeCard: {
      auxiliaryFields: [
        {
          key: "auxiliary-id",
      ...
      backFields: [
        {
          key: "back-info",
          label: "💡 ANY INFO",
          value: "Sample contract details — see example.com/contract for full text.",
        },
        {
          key: "back-assistance",
